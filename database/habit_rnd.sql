...
--
-- Host: localhost    Database: habit_rnd
-- ------------------------------------------------------
...
INSERT INTO `frequency` VALUES (1,'DAILY'),(2,'WEEKLY'),(3,'MONTHLY'),(4,'YEARLY');
...
CREATE TABLE `habit` (
  ...
  `habit_list_id` int(11) DEFAULT NULL,
  `frequency_id` int(11) NOT NULL,
  `part_of_week_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `habit_habit_list_idx` (`habit_list_id`),
  KEY `habit_frequency_idx` (`frequency_id`),
  KEY `habit_part_of_week_id_idx` (`part_of_week_id`),
  CONSTRAINT `habit_frequency` FOREIGN KEY (`frequency_id`) REFERENCES `frequency` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `habit_habit_list` FOREIGN KEY (`habit_list_id`) REFERENCES `habit_list` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `habit_part_of_week_id` FOREIGN KEY (`part_of_week_id`) REFERENCES `part_of_week` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `habit` VALUES (1,'Pay Bills',NULL,NULL,NULL,2,1),(2,'Tidy up',NULL,NULL,NULL,1,NULL),(3,'Go to sleep before 10:30',NULL,NULL,4,1,NULL),(4,'Meditate',NULL,NULL,4,1,NULL),(5,'Draw',NULL,NULL,3,2,NULL),(6,'Call mom',NULL,NULL,1,3,NULL),(7,'Floss',NULL,NULL,4,1,NULL),(8,'Finish Homework',NULL,NULL,NULL,1,NULL),(9,'Go to sleep before 1:00',NULL,NULL,4,1,NULL),(10,'Exercise',NULL,NULL,NULL,1,NULL),(11,'Practice music instrument',NULL,NULL,3,2,2),(12,'Take nature pictures',NULL,NULL,3,3,NULL),(13,'Visit relatives',NULL,NULL,1,3,NULL);
...
INSERT INTO `habit_list` VALUES (1,'Family','2017-09-25 10:35:00',1,'\0'),(2,'Work','2014-02-13 23:00:00',1,'\0'),(3,'Hobby','2014-09-04 22:00:00',2,''),(4,'Personal','2014-10-21 22:00:00',2,'\0');
/*!40000 ALTER TABLE `habit_list` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `part_of_week`
--

DROP TABLE IF EXISTS `part_of_week`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `part_of_week` (
  `id` int(11) NOT NULL,
  `name` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `part_of_week`
--

LOCK TABLES `part_of_week` WRITE;
/*!40000 ALTER TABLE `part_of_week` DISABLE KEYS */;
INSERT INTO `part_of_week` VALUES (1,'WEEKDAYS'),(2,'WEEKEND');
/*!40000 ALTER TABLE `part_of_week` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-14 23:30:10
